<?php
	...
	function sb_language( $page ) {
		...
		$lang_string['menu_commentmoderation'] = "Commentaires non modérés"; // New for 0.5.0
		$lang_string['menu_random_entry'] = "Entrée aléatoire"; // New for 0.5.2
		$lang_string['menu_plugins'] = "Plugins"; // New for 0.5.2
		$lang_string['notice_moderator1'] = "Vous avez ";
		$lang_string['notice_moderator2'] = " commentaire(s) nécessitant votre approbation.";
		$lang_string['notice_loggedin'] = "Vous êtes actuellement identifié.";
		...
		$lang_String['randomentry'] = 'Entrée aléatoire'; // New in 0.5.0.1
		$lang_string['randomquote'] = 'Citation aléatoire'; // New in 0.5.0.1
		...
		$lang_string['sb_read_entry_btn'] = 'lire entrée'; // 0.5.0
		...
		switch ($page) {
			...
			case 'comments':
				...
				$lang_string['email_moderator'] = "Les commentaires sont modérés. Ce commentaire doit être approuvé avant d'être vu par le public."; // New for 0.5.0
				$lang_string['user_notice_mod'] = "Ce blog est modéré. Votre commentaire nécessite l'approbation des administrateurs avant d'être visible."; // new for 0.5.0
				...
				$lang_string[ 'error_comments_disabled' ] = '<h2>Erreur!</h2>Hey! Les commentaires sont désactivés sur ce blog. Êtes-vous un spambot?'; // New 0.5.0
				$lang_string[ 'error_no_match' ] = "<h2>Erreur!</h2>Votre adresse IP ne correspond pas à l'IP de l'entrée. Êtes-vous un spambot?"; // New 0.5.0
				$lang_string[ 'error_fields_missing' ] = '<h2>Erreur!</h2>Les champs suivants ne sont pas renseignés: '; // New 0.5.0
				$lang_string[ 'error_spambot' ] = '<h2>Erreur!</h2>Il manque les données capcha. Êtes-vous un spambot?'; // New 0.5.0
				$lang_string[ 'error_capcha' ] = '<h2>Erreur!</h2>Le capcha entré est incorrect.'; // New 0.5.0
				$lang_string[ 'error_bad_data' ] = '<h2>Erreur!</h2>Données POST invalides. Êtes-vous un spambot?'; // New 0.5.0
				$lang_string[ 'error_entry_missing' ] = '<h2>Erreur!</h2>Vous essayez de mettre un commentaire sur une entrée qui n\'existe pas.'; // New 0.5.0
				$lang_string[ 'error_empty_text' ] = '<h2>Erreur!</h2>Vous n\'avez mis aucun commentaire ou pas précisé votre nom.'; // New 0.5.0
				break;
			...
			case 'info':
				...
				$lang_string['tracking_code'] = "Code de tracking externe: (code HTML ayant besoin de tourner sur la page principale (dans les tags d\{en-tête par sécurité) uniquement pour chaque utilisateur qui arrive sur la page - par ex. Google Analytics)";
				$lang_string['submit_btn'] = "&nbsp;Envoyer&nbsp;";
				// Error Response
			...
			case 'login':
				...
				$lang_string['inactive_account'] = "<h2>Oooups!</h2>Vous n'êtes pas connecté. Votre compte a été désactivé par un administrateur.<p />";
			...
			case 'logout':
				...
				$lang_string['error_no_cookie'] = "<h2>Au revoir!</h2>Vous êtes maintenant déconnecté. (Le cookie n'a pas été trouvé. Vous n'étiez pas connecté de toutes manières!)<p />"; // New 0.5.0
			...
			case 'setup':
				...
				$lang_string['blog_header'] = "URL d'en-tête graphique: images/blogheader.jpg (Laissez blanc pour l'image par défaut du thème).";
				...
				$lang_string['blog_enable_start_category'] = "Utilise une catégorie spécifique pour la première page des entrées: "; // Now for 0.5.1
				$lang_string['blog_search_top'] = "Afficher la recherche dans les entrées (au lieu de la barre de menu)"; // New for 0.5.0
				$lang_string['blog_enable_static_block'] = "Affiche un bloc particulier comme première entrée des entrées du blog: "; // New for 0.5.0
				...
				$lang_string['blog_comments_moderation'] = "Les commentaires du blog doivent être approuvés par un utilisateur identifié avant d'être rendus publics
				  (toujours visibles pour un utilisateur identifié)"; // New in 0.5.0
				$lang_string['comment_moderation'] = "Options de modération"; // New in 0.5.0
				break;
			case 'comment_moderation':
				$lang_string['title'] = "Commentaires non modérés";
				$lang_string['instructions'] = "Voici une liste de tous les commentaires non disponibles pour les utilisateurs non identifiés
					car ils n'ont pas été approuvés par un modérateur.";
				$lang_string['header'] = "Liste de modération";
				$lang_string['enteredby'] = "Entré par: ";
				$lang_string['entrydate'] = "Entré le: ";
				$lang_string['blogentrytitle'] = "Titre de l'entré de blog: ";
				$lang_string['enteredcontent'] = "Contenu: ";
				$lang_string['totalunmodded'] = " élément(s) au total attendant d'être approuvés.";
			...
			case 'manage_users':
				$lang_string['title'] = "Gestion des utilisateurs rédacteurs";
				$lang_string['instructions'] = "Ajouter, modifier ou supprimer des utilisateurs qui ne sont pas administrateurs, mais peuvent créer des entrées de blog et/ou modérer les commentaires.";
				$lang_string['fulladminerror'] = "Vous devez être un véritable administrateur pour accéder à cet écran!";
				...
				$lang_string['prop_fullname'] = "Nom affiché:";
				...
				$lang_string['prop_sec_Moderate'] = "Modère les commentaires?";
				$lang_string['prop_sec_Delete'] = "Supprime les entrées de blog?";
				$lang_string['prop_sec_Edit'] = "Modifier n'importe quelle entrée?";
				...
				$lang_string['create_user'] = 'Créer nouvel utilisateur';
				break;
